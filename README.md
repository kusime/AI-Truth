...
这个项目探索了神经网络的**物理本质**,通过 13 个哲学直觉和对应的数学验证,揭示了 AI 背后的深层原理:
...
| **Sec 11** | [神经坍缩](src/sec_11_collapse.py) | 训练终态的几何奥秘 | Papyan et al. (2020) |
| **Sec 12** | [维度碰撞](src/sec_12_collision.py) | 高维唯一性与低维信息丢失 | Johnson-Lindenstrauss (1984) |
| **Sec 13** | [Δy 等价性](src/sec_13_delta_y_equivalence.py) | 第一性原理证明 Attention = 梯度下降 | von Oswald et al. (2023) |
